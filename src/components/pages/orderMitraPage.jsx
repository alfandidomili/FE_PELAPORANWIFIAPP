...
const orderMitraPage = ({ orderData, orderRequest, userMeRequest, user }) => {
   const {
...
export default connect(mapStateToProps, mapDispatchToProps)(orderMitraPage);
